...
//    ));
    ...
    public static final Item Magic_Tart = registerItem("magic_tart", new ZeldaMagicFood(
            new FabricItemSettings().food(new FoodComponent.Builder().nutrition(6).saturationModifier(0.4F).alwaysEdible().build()), 40));
    public static final Item Magic_Flan = registerItem("magic_flan", new ZeldaMagicFood(
            new FabricItemSettings().food(new FoodComponent.Builder().nutrition(8).saturationModifier(0.8F).alwaysEdible().build()), 100));
    public static final Item Edible_Magic_Mushroom = registerItem("edible_magic_mushroom", new ZeldaMagicFood(
            new FabricItemSettings().food(new FoodComponent.Builder().nutrition(7).saturationModifier(0.4F).alwaysEdible().build()), 50));
    ...
    public static final Item Armos_Spawn_Egg = registerItem("armos_spawn_egg", new SpawnEggItem(
            ZeldaEntities.Armos_Entity, 0x4d4d55, 0xfad64a, new FabricItemSettings()));
