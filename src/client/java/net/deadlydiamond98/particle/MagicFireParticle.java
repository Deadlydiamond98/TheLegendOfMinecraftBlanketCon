...
public class MagicFireParticle extends SpriteBillboardParticle {
    ...
    public static class MagicFireParticleFactory implements ParticleFactory<DefaultParticleType> {
        ...
        @Override
        public MagicFireParticle createParticle(DefaultParticleType type, ClientWorld world, double x, double y, double z, double velocityX, double velocityY, double velocityZ) {
