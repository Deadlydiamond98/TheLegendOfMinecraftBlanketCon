...
public class MagicIceParticle extends SpriteBillboardParticle {
    ...
    protected MagicIceParticle(ClientWorld world, double x, double y, double z, SpriteProvider spriteProvider) {
        super(world, x, y, z);
        this.maxAge = 20;
    ...
    public static class MagicIceParticleFactory implements ParticleFactory<DefaultParticleType> {
        ...
        public MagicIceParticleFactory(SpriteProvider spriteProvider) {
            this.spriteProvider = spriteProvider;
        }
