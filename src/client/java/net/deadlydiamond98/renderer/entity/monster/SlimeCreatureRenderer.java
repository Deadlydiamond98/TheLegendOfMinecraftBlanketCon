...
public class SlimeCreatureRenderer extends MobEntityRenderer<SlimeEntity, SlimeEntityModel<SlimeEntity>> {
    private static final Identifier TEXTURE = new Identifier("textures/entity/slime/slime.png");

    public SlimeCreatureRenderer(EntityRendererFactory.Context context) {
