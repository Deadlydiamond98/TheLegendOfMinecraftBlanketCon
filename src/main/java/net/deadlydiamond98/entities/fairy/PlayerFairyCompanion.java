    ...
    private void handleIdleMovement(PlayerEntity player) {
        ...
        if (this.idleTime <= 600) {
            if (this.idleTime <= 500) {
                ...
                double offsetX = offsetLeft * MathHelper.cos((float) yawRad) - offsetFront * MathHelper.sin((float) yawRad);
                double offsetZ = offsetLeft * MathHelper.sin((float) yawRad) + offsetFront * MathHelper.cos((float) yawRad);
